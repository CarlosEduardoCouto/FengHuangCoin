...
// Copyright (c) 2011-2015 The FengHuangCoin developers
...
{
    // Wait for IRC to get it first - disabled with fhcoin
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "FHCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
// testnet dns seed begins with 't', all else are fhcoin dns seeds.
static const char *strDNSSeed[][2] = {
    {"seed", "seed.fhcoin.club"},
    {"seedFHc", "seedFHc.fhcoin.club"},
    {"tnseed", "tnseed.fhcoin.club"},
    {"tnseedFHc", "tnseedFHc.fhcoin.club"},
};
...
void ThreadDNSAddressSeed2(void* parg)
{
    ...
    if (true /*!fTestNet*/)  // fhcoin enables dns seeding with testnet too
    {
...
bool BindListenPort(string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, sizeof(sockaddr)) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to port %d on this computer.  FHCoin is probably already running."), ntohs(sockaddr.sin_port));
        else
...
void StartNode(void* parg)
{
    ...
    // fhcoin: mint proof-of-stake blocks in the background
