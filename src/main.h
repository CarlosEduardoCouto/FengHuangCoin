...
static const int COINBASE_MATURITY_FHC = 500;
...
public:
    ...
    {
        // fhcoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // fhcoin: get transaction coin age
...
public:
    ...
    // fhcoin: block signature - signed by coin base txout[0]'s owner
    ...
    // fhcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // fhcoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // fhcoin: calculate total coin age spent in block
    bool SignBlock(const CKeyStore& keystore);
    bool CheckBlockSignature() const;
    unsigned int GetStakeEntropyBit() const; // fhcoin: entropy bit for stake modifier if chosen by modifier
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // fhcoin: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // fhcoin: block index flags
    enum  
    {
