...
namespace Checkpoints
{
    ...
    // fhcoin: synchronized checkpoint (centrally broadcasted)
    ...
    // fhcoin: get last synchronized checkpoint
    ...
    // fhcoin: only descendant of current sync-checkpoint is allowed
    ...
    // fhcoin: reset synchronized checkpoint to last hardened checkpoint
...
// fhcoin: sync-checkpoint master key
...
// fhcoin: verify signature of sync-checkpoint message
...
// fhcoin: process synchronized checkpoint
